...
local optionsstate = require('states.optionsstate')
...
function menustate.new()
  ...
  local btnoptions = uibutton.new()
  btnoptions.text = "Options"
  btnoptions.events.click:add(function()
    instance:sm():push(optionsstate.new())
  end)
  ...
  stackpanel:addchild(btnoptions)
